...
//    private BufferedReader in;
    ...
    public login() {
        initComponents();
//      conectarAoServidor();
        cliente = Cliente.getInstance("127.0.0.1", 10008);        //cliente.conectar();
    }
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(isError){
            mostrarAviso(retorno.get("message").asText());
                ...
                boolean admin = createJWT.isAdmin(retorno.get("token").asText());
                if (admin){
                    indexAdmin index = new indexAdmin();
                    this.dispose();
                    index.setVisible(true);
                } else{
                    indexCliente index = new indexCliente();
                    this.dispose();
                    index.setVisible(true);
                }
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        cadastroCliente cadastraCliente = new cadastroCliente();
        this.dispose();
